...
Vehicle_Observer::Vehicle_Observer(Server_Interface * interface)
	: Server_Observer(interface)
{
}

bool Vehicle_Observer::Received_Package(Client & client, boost::shared_ptr<Package> pPackage)
{
	switch(pPackage->GetType())
	{
	case Package::VEHICLE_ALARM:
